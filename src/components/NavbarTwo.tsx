...
const NavbarTwo: React.FC = () => {
  return (
    <nav>
      <div className="container mx-auto flex items-center justify-between max-w-xs">
        <Link to="/" className="text-xl font-bold text-[#3B3D87]">
          <img src={logo} alt="Logo" className="h-3 sm:h-5" />
        </Link>
