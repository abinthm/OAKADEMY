...
const Hero = () => {
  return (
    <section className="bg-[#F5F0F0] relative overflow-hidden h-[70vh] lg:h-[calc(100vh-4rem)]">
      <div className="container mx-auto h-full lg:max-w-none lg:px-0">
        <div className="flex flex-col lg:flex-row lg:items-center relative h-full">
          ...
          {/* Left Side - Content */}
          <div className="w-full lg:w-1/2 px-6 lg:px-12 flex flex-col justify-end lg:justify-center h-full pb-16 lg:py-0 relative z-20">
            {/* Heading */}
            ...
            <a 
              ...
              className="inline-flex items-center bg-transparent text-white border-2 border-white lg:text-[#3B3D87] lg:border-[#3B3D87] px-6 py-2 
                font-medium text-base hover:bg-white hover:text-[#3B3D87] lg:hover:bg-[#3B3D87] lg:hover:text-white transition-colors duration-300 w-fit"
            >
              JOIN US
              <svg 
